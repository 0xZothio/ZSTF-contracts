...
const whiteListManagerCoreTestnetChain="0xBFff78BB02925E4D8671D0d90B2a6330fcAedd87";
...
async function main() {
  ...
  const poolName = "Zoth Pool 7";
  const poolSymbol = "ZP7";
  ...
  const ZothPool = await hre.ethers.deployContract("ZothPool", [
    whiteListManagerCoreTestnetChain,
    0,
    poolName,
    poolSymbol,
    baseUri,
    getSecondsOfDays(7),
    ["0x849DE829150D9233E0f835Cc4E4E45177079c9E0"],
    getSecondsOfDays(30),
